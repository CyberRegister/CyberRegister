    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('expertise.store') }}" class="register">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="date_of_certification" type="date" class="form-control{{ $errors->has('date_of_certification') ? ' is-invalid' : '' }}" name="date_of_certification" value="{{ old('date_of_certification') }}" required>
                            ...
                            <div class="col-md-4">
                                <input id="date_of_expiration" type="date" class="form-control{{ $errors->has('date_of_expiration') ? ' is-invalid' : '' }}" name="date_of_expiration" value="{{ old('date_of_expiration') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="certification_code" type="certification_code" class="form-control{{ $errors->has('certification_code') ? ' is-invalid' : '' }}" name="certification_code" value="{{ old('certification_code') }}" required>
